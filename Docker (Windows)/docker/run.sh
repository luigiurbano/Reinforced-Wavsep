...
echo "CREATE USER 'wavsep'@'%' IDENTIFIED BY 'wavsepPass782';" >> grant.sql
echo "GRANT ALL PRIVILEGES ON *.* TO 'wavsep'@'%' WITH GRANT OPTION;" >> grant.sql
echo "FLUSH PRIVILEGES;" >> grant.sql
mysql -u root -h ${MYSQL_HOST} -P 3306 -pwavsep < grant.sql
