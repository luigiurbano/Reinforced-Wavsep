...
<title>Evaluation of OS Command Injection Detection Accuracy - HTTP POST Method</title>
</head>
<body>
...
<center><font size="5">OS Command Injection Test Cases - HTTP 500 Valid Responses:</font></center><br><br>
...
<br/>
  ...
  <TR><TD>
  <B>Independent Exploit 1 (Windows):</B> type c:\windows\win.ini <br>
  <B>Independent Exploit 2 (Linux):</B> cat /etc/passwd<br>
  </TD></TR>
  </TABLE>  
  <br>
  ...
  <TR><TD>
  <B>Independent Exploit 1 (Windows):</B> c:\windows\win.ini <br>
  <B>Independent Exploit 2 (Windows):</B> eclipse.ini | type c:\windows\win.ini <br>
