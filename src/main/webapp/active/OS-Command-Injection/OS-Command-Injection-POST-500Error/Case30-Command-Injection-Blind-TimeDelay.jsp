...
<title>Case 2 - Injection into search parameter to execute a command. Goal: exploit the blind OS command injection vulnerability to cause a 10 second delay.</title>
</head>
