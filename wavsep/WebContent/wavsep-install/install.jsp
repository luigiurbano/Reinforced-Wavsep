...
<b><u>Prerequisite:</u></b><br>MySQL >= 5.5.x database must be installed (8.0.22 is strongly recommended), before proceeding with the WAVSEP installation process.<br>
