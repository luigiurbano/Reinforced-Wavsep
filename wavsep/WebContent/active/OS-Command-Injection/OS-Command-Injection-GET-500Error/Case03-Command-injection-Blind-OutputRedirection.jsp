...
<title>Case 3 - Injection into GET parameter to execute a command. Goal: redirect the output from the injected command to a file in this folder, and then use the image loading URL to retrieve the contents of the file.</title>
</head>
...
%>
	...
	<form name="frmInput" id="frmInput" action="Case01-Command-Injection-SimpleCase.jsp?image=/wavsep/images/wavsep-logo.jpeg" method="POST">
